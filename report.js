 ...
 * 
 * 
 *      JavaScript for the report view!
 * 
 * 
 * 
 */
            ...
            $(function () {
                ...
                var TableRow = (function () {
                    ...
                    function Row(thisSubmittedAssignment) {
                        ...
                        // NEW TEST wiring up the "user_page" button to open up that user's page,
                ...
                function retrieveSubmittedData(inputs) {
                    ...
                    $.getJSON("/report_stuff", data).done(function (d) {
                        ...
                        d.completedAssignments.forEach(function (thisAssignment) {
                            ...
                            if (thisAssignment.new_kyoushitsu) {
                                console.log(thisAssignment.new_kyoushitsu);
                            }
                ...
                // Countdown timer that fires off a callback (AJAX request) every ~10 seconds,
